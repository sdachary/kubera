...
Doorkeeper.configure do
  ...
  #
  # Make kubera you properly setup you database and have all the required columns (run
  ...
  #
  # When enabling this option, make kubera that you do not expect multiple processes
  ...
  #
  # This will enkubera that old access tokens and secrets
  ...
  # them to make kubera you doesn't get NoMethodError exception.
  #
